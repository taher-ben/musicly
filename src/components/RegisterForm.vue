<template>
    <!-- Registration Form -->
    <div class="text-white text-center font-bold p-3 rounded mb-4" v-if="reg_show_alert" :class="reg_alert_variant">
        {{ reg_alert_msg }}
    </div>
    <VeeForm :disabled="reg_in_submission" :validation-schema="schema" @submit="register" :initial-values="userData">
        <div class="mb-3">
